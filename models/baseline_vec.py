...
from sklearn.feature_extraction.text import TfidfVectorizer # changed the vectorized transformation from CountVectorizer to TFIDF
...
def main():
    ...
    featurizer = ColumnTransformer(
        transformers=[("title", TfidfVectorizer(), "title"),("abstract", TfidfVectorizer(), "abstract")],
